...
- [How to be an iOS only developer](/td/ios-nomad)
- [Hacking the web for fun and profit](/td/hack-web)
- [In Real Life](/irl)

### Minor Tips

- [Time off 2020](/timeoff-2020-03)
- [VLC Player](/vlc)
- [Pandas](/pandas)
- [iOS Usage](/td/ios)
- [Mosh](/mosh)
- [Visual Vocabulary](/td/visual-vocabulary)
...
- [Ring Video Downloader](https://github.com/idvorkin/LinqPadSnippets/blob/master/python/ring-video-doorbell.py)
- [Extract message history on OSX](/td/dump_imessage_history)
...
- [Windows Virtual Desktop switcher](https://github.com/idvorkin/techdiary/blob/master/virtual-desktops.md)
- Alexa Skill
- Grammarly editor SDK embed (Grammarly killed the SDK)
- ManageMe (repo retired)
- [Habit tracking app](https://github.com/idvorkin/techdiary/blob/master/streaks.md) - the Streaks app already does this perfectly, but it's still a good template project for learning a new language or library
