...
- [How to measure the effectiveness of ML by problem category](#how-to-measure-the-effectiveness-of-ml-by-problem-category)
  ...
  - [Regression - Distance from prediction to actual](#regression---distance-from-prediction-to-actual)
...
- [About ML errors](#about-ml-errors)
  ...
  - [Likelihood of death from Pneumonia given asthma](#likelihood-of-death-from-pneumonia-given-asthma)
...
- [The steps in training an ML model](#the-steps-in-training-an-ml-model)
  ...
  - [Training](#training)
  - [Evaluation and tuning of model family features and hyperparameters](#evaluation-and-tuning-of-model-family-features-and-hyperparameters)
