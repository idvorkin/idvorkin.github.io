  ...
  `;e.bind("?",e=>alert(t))}function y(){console.log("\uD83D\uDD04 Replacing List Placeholders in Tables"),function(e){Object.entries(e).forEach(([e,t])=>{let n=$(`a[href=${e}]`).first();if(!n.length)return;let o=$(t).clone();o.children().first().remove(),n.replaceWith(o),$(t).remove()})}(function(){let e={};return $("ul").each((t,n)=>{let o=n.firstElementChild;if(!o)return;let a=o.textContent;a&&a.startsWith("l")&&(isNaN(parseInt(a.substring(1)))||(e[a]=n))}),e}())}function w(){$(f),$(D),$(document).ready(y),console.log("\uD83D\uDE80 About to call initRecentPosts from main.ts"),console.log("\uD83D\uDD0D initRecentPosts called"),"loading"===document.readyState?(console.log("\uD83D\uDD0D Document still loading, adding DOMContentLoaded listener"),document.addEventListener("DOMContentLoaded",()=>{console.log("\uD83D\uDD0D DOMContentLoaded event fired, calling updateRecentPosts()"),i()})):(console.log("\uD83D\uDD0D Document already loaded, calling updateRecentPosts() immediately"),i()),console.log("\uD83D\uDD0D initRecentPosts completed initial setup"),console.log("✅ Called initRecentPosts from main.ts"),document.getElementById("last-modified-posts")&&(console.log("\uD83D\uDE80 About to call initRecentAllPosts from main.ts"),r(),console.log("✅ Called initRecentAllPosts from main.ts")),$(function(){u("ui-toc",!0),u("ui-toc-affix",!1)})}let{autocomplete:v,getAlgoliaResults:_}=window["@algolia/autocomplete-js"];function k({item:e,createElement:t}){return t("div",{dangerouslySetInnerHTML:{__html:function(e){try{let t=e.url;e.anchor&&(t+=`#${e.anchor}`);let n=e._highlightResult;n||console.log("No Highlight",e);let o=n.title.value,a=n?.content?.value??"";return`
        ...
        `}catch(t){console.log("Error in hitTemplate",t,e)}return"invalid HTML"}(e)}})}async function M(){let t=e(Object.entries(await a()).map(e=>e[1]));return{title:t.title,url:t.url,description:t.description}}async function x(e=4){try{let t=await a();return Object.entries(t).map(([e,t])=>({url:e,title:t.title||e,description:t.description||"",doc_size:t.doc_size||0,last_modified:t.last_modified||""})).filter(e=>e.description&&""!==e.description.trim()&&e.title&&""!==e.title.trim()).sort((e,t)=>e.last_modified&&t.last_modified?new Date(t.last_modified).getTime()-new Date(e.last_modified).getTime():t.doc_size-e.doc_size).slice(0,e)}catch(e){return console.error("❌ Error loading recent posts:",e),[]}}async function T(e=3){return{sourceId:"random_posts",async getItems(){let t=Array(e).join("_").split("_");return await Promise.all(t.map(async e=>M()))},getItemUrl:({item:e})=>e.url,templates:{item:({item:e,createElement:t})=>t("div",{dangerouslySetInnerHTML:{__html:`
           ...
           <b> <a href="${e.url}">${e.title}</a></b>
            ...
            `}}),header:({createElement:e})=>e("div",{dangerouslySetInnerHTML:{__html:"<i style='color:grey'>Recent posts ...</i>"}})}}}async function P(e,t,n,o,a,i=3,l=4,r=3){let s=algoliasearch(e,t),c=await T(r),d=await L(l),u=o.startsWith("#")?o:`#${o}`;if(0===$(u).length){console.log("No autocomplete element found","autocomplete_id",o);return}return v({container:u,placeholder:"Search Igor's Musings ...",getSources:function({query:e}){let t=0===e.length;t&&(e=" ");let o=function(e,t,n,o=3,a=!1){let i="NOT tags:family-journal";return a&&(i=""),{sourceId:"featured_posts",getItems:()=>_({searchClient:e,queries:[{indexName:t,query:n,filters:i,params:{hitsPerPage:o,highlightPreTag:"<span style='background:yellow'>",highlightPostTag:"</span>"}}]}),templates:{item:k,header:({createElement:e})=>e("div",{dangerouslySetInnerHTML:{__html:"<i style='color:grey'>Featured posts ...</i>"}})},getItemUrl({item:e}){let t=e.url;return e.anchor&&(t+=`#${e.anchor}`),t}}}(s,n,e,t?i:10,a);return t?[o,d,c]:[o]},debug:!1,openOnFocus:!0,detachedMediaQuery:""})}class C{constructor({name:e,value:n=25,children:o=[]}){this.name=e,this.children=t(o),this.value=n}}function j(){let t=E();for(let o of t.keys())!function(t,o){let a=$('<div class="alert alert-primary" role="alert"/>');$(t).after(a),n(a,()=>`<span>${e(o)}</span>`)}(o,t.get(o))}function E(){let e=$("h3").first(),t=e,n=[],o=new Map;for(let a=e;0!=a.length;a=$(a).next()){if("H3"==a.prop("tagName")){o.set(t,n),t=a,n=[];continue}"UL"==a.prop("tagName")&&(n=Array.from($(a).find("li")).map(e=>$(e).text()))}return o.set(t,n),o}function*H(e){if(!e)return;let t=[];for(t.push([e,null]);t.length>0;){let[e,n]=t.shift();for(let n of e.children??[])t.push([n,e]);yield[e,n]}}function O(){return new Map(Array.from(E().entries()).map(([e,t],n)=>[e.text(),t]))}function R(t,n,o){let[a,i]=Array.from(H(n)).find(([e,n])=>e.name==t);return e(Array.from(H(a)).map(([e,t])=>e).filter(e=>o.has(e.name)).map(e=>o.get(e.name).map(t=>`${e.name}: ${t}`)).flat())}async function z(e,t,n){let o=function(e){let t=Array.from(H(e)).map(([e,t])=>[e.name,t?.name]);return{ids:t.map(([e,t])=>e),labels:t.map(([e,t])=>e),parents:t.map(([e,t])=>t)}}(n);var a={type:"sunburst",outsidetextfont:{size:20,color:"#377eb8"},hoverinfo:"none",marker:{line:{width:2}},maxdepth:2,displayModeBar:!1};Object.assign(a,o),delete a.values;let i=await Plotly.newPlot(e,[a],{margin:{l:0,r:0,b:0,t:0},sunburstcolorway:["#636efa","#ef553b","#00cc96"]},{displayModeBar:!1}),l=e=>{console.log("set_random_prompt_text",e),$(`#${t}`).text(e)};$(`#${t}`).first().click(()=>{l(R($("#sunburst text:first").text(),n,O()))}),i.on("plotly_sunburstclick",e=>{l(R(e.points[0].label,n,O()))})}function S(e){let t=$("<div/>"),n=`<h4> <a href='${e.url}'}>${e.title}</a></h4>`;t.append(n);let o=e.thumbnail.replace("s72-c","s320"),a=new Date(e.published),i=`
   ...
   `;return""!=e.thumbnail?(console.log(e.title),console.log(a),t.append(`
      ...
      ${i}
      </div>`)):t.append(i),t.html()}function I(t){if(console.log("Processing",t.length,"posts"),!t){console.log("No posts being imported");return}n("#random-post",()=>S(e(t))),n("#achievment",()=>S(e(t.filter(e=>e.title.toLowerCase().includes("achievement"))))),n("#random-recent",()=>S(e(t.filter(e=>e.tags.includes("family-journal")))))}function N(){$.getJSON("/ig66/ig66-export.json",I)}function A(t){$.getJSON("/eulogy.json",o=>(function(t,o){if(!o){console.log("No roles being imported");return}console.log("Processing",o.roles.length,"roles"),n(t,()=>(function(e){let t=e.title.replace(/ /g,"%20"),n=["igor","ammon"],o=n[Math.floor(Math.random()*n.length)];return`
  <div>
