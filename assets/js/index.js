...
Try these shortcuts:
  ...
  `})(o(t.roles)))})(e,t))}"undefined"!=typeof $&&$.fn&&$.fn.ready?$(document).ready(q):"undefined"!=typeof document&&("loading"===document.readyState?document.addEventListener("DOMContentLoaded",q):q());class K{constructor({name:e,value:t=25,children:n=[]}){this.name=e,this.children=i(n),this.value=t}}function X(e=et,t=ee){let n=e();for(let e of n.keys())t(e,n.get(e))}function ee(e,t,n=$,i=a){let r=n('<div class="alert alert-primary" role="alert"/>');n(e).after(r),i(r,()=>`<span>${o(t)}</span><span style="float: right; cursor: pointer;" title="Click for another prompt">\u{1F504}</span>`)}function et(e=$){let t=e("h3").first(),n=t,o=[],i=new Map;for(let r=t;0!==r.length;r=e(r).next()){if("H3"===r.prop("tagName")){i.set(n,o),n=r,o=[];continue}"UL"===r.prop("tagName")&&(o=Array.from(e(r).find("li")).map(t=>e(t).text()))}return i.set(n,o),i}function*en(e){if(!e)return;let t=[];for(t.push([e,null]);t.length>0;){let[e,n]=t.shift();for(let n of e.children??[])t.push([n,e]);yield[e,n]}}function eo(e=et){return new Map(Array.from(e().entries()).map(([e,t],n)=>[e.text(),t]))}function ei(e,t,n){let i=Array.from(en(t)).find(([t,n])=>t.name===e);if(!i)return"Click in any box or circle";let[r,a]=i,l=Array.from(en(r)).map(([e,t])=>e).filter(e=>{let t=n.has(e.name),o=n.has(`${e.name}\u{1F517}`);return t||o}).flatMap(e=>(n.get(e.name)||n.get(`${e.name}\u{1F517}`)||[]).map(t=>`${e.name}: ${t}`));return 0===l.length?"Click in any box or circle":o(l)}async function er(e,t,n,o=$,i=Plotly){if(!i){console.error("Plotly is not available");return}let r=function(e){let t=Array.from(en(e)).map(([e,t])=>[e.name,t?.name]);return{ids:t.map(([e,t])=>e),labels:t.map(([e,t])=>e),parents:t.map(([e,t])=>t)}}(n),a={type:"sunburst",outsidetextfont:{size:20,color:"#377eb8"},hoverinfo:"none",marker:{line:{width:2}},maxdepth:2,displayModeBar:!1};Object.assign(a,r),a.values=void 0;try{await i.newPlot(e,[a],{margin:{l:0,r:0,b:0,t:0},sunburstcolorway:["#636efa","#ef553b","#00cc96"]},{displayModeBar:!1});let r=e=>{o(`#${t}`).text(e)};o(`#${t}`).first().click(()=>{let e=o("#sunburst text:first").text(),t=ei(e,n,eo());r(t)});let l=document.getElementById(e);return l&&"function"==typeof l.on&&l.on("plotly_click",e=>{if(e?.points?.[0]){let t=e.points[0].label,o=ei(t,n,eo());r(o)}}),l}catch(e){return console.error("Failed to create sunburst plot:",e),null}}async function ea(e,t,n="Root",o=null,i=$,r=Plotly){return er(e,t,function(e="Root",t=null,n=$){let o=t?n(t).find("h2"):n("h2"),i=[];return o.each((e,t)=>{let o=n(t),r=o.text().trim();if(!r)return;let a=[],l=o.next();for(;l.length>0&&"H2"!==l.prop("tagName");){if("H3"===l.prop("tagName")){let e=l.text().trim();e&&a.push(new K({name:e}))}l=l.next()}a.length>0&&i.push(new K({name:r,children:a}))}),new K({name:e,children:i})}(n,o,i),i,r)}class el{get_tree(){return new K({name:"7H ",children:[new K({name:""}),new K({name:"Be Proactive"}),new K({name:"Begin with the end in mind"}),new K({name:"First things First"}),new K({name:"Think Win/Win"}),new K({name:"First Understand"}),new K({name:"Synergize"}),new K({name:"Sharpen the Saw"})]})}}class es{get_tree(){let e=new K({name:"Health",children:[{name:"Physical"},{name:"Emotional"},{name:"Cognative"}],value:31}),t=new K({name:"Magic",children:[new K({name:"Card Magic"}),new K({name:"Coin Magic"}),new K({name:"Band Magic"})]}),n=new K({name:"Hobbies",children:[new K({name:"Biking"}),new K({name:"Tech"}),new K({name:"Juggling"})]}),o=new K({name:"Relationships",children:[new K({name:"Zach"}),new K({name:"Amelia"}),new K({name:"Tori"}),new K({name:"Friends"})]}),i=new K({name:"Joy",children:[new K({name:"Balloons"}),new K({name:"Joy to Others"})]});return new K({name:"Invest in",children:[e,t,n,o,i]})}}function ec({url:e,title:t,description:n}){let o=`<a href='${e}'}>${t}</a>`,i=`audio_player_${Math.floor(1e10*Math.random())}`,r=e.replace(/\//g,"_");return`
    <div>
        <audio id='${i}'>
  ...
  `}async function ed(e=s,t=o){try{let n=await e(),o=Object.entries(n).map(e=>e[1]),i=t(o);return ec({url:i.url,title:i.title,description:i.description})}catch(e){return console.error("Error generating random post HTML:",e),"<div>Could not load random post</div>"}}function eu(e="#e1",t="#e2",n="#e3",o=Z){try{o(e),o(t),o(n)}catch(e){console.error("Error loading random eulogy:",e)}}function ep(e=er,t=X,n=Q,o=Z,i=a){try{e("sunburst","sunburst_text",new es().get_tree()),t(),n(),o("#random-eulogy-role"),i("#random-blog-posts",async()=>await ed())}catch(e){console.error("❌ Error loading enjoy page:",e)}}function ef(e=er,t=X){try{e("sunburst","sunburst_text",new el().get_tree()),t()}catch(e){console.error("Error loading 7 habits page:",e)}}function eg(e=Q){try{e()}catch(e){console.error("Error loading IG66 page:",e)}}function em(e=ew,t=e$,n=eb){try{e("balance-heatmap-rest"),t("balance-heatmap-work"),n("balance-radar-map-ideal")}catch(e){console.error("Error loading balance page:",e)}}let eh=["Jan","Feb","Mar","Apr","May","June","July","Aug","Sep","Oct","Nov","Dec"],ey="#00BF00";async function eb(e,t){if(void 0!==t&&t)try{await t.newPlot(e,[{type:"scatterpolar",r:[8,8,8,5,8,8,8],theta:["Work","Tech","Health","Hobbies","Relationships","Magic","Work"],name:"2020 Goal",fill:"toself"},{type:"scatterpolar",r:[7,7,5,5,5,9,7],theta:["Work","Tech","Health","Hobbies","Relationships","Magic","Work"],name:"2020 Actual",fill:"toself"}],{polar:{radialaxis:{visible:!0,range:[0,10]}},showlegend:!0},{displayModeBar:!1})}catch(e){console.error("Error creating radar map:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}async function e$(e,t){let n=["Tech","Work"],o={height:20*n.length+100,margin:{t:5},pad:0},i=[{colorscale:[[0,"darkblue"],[.4,"blue"],[.5,ey],[.6,"darkred"],[1,"red"]],zmin:0,zmax:10,x:eh.slice(2,13),y:n,z:[[7,4,7,8,2,4,2,3,2,8],[10,7,5,5,3,5,6,6,7,5]],type:"heatmap"}];if(void 0!==t&&t)try{await t.newPlot(e,i,o,{displayModeBar:!1})}catch(e){console.error("Error creating work balance chart:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}async function ew(e,t){let n=["Health","Hobbies","Family","Magic"],o=[{colorscale:[[0,"red"],[.4,"darkred"],[.5,ey],[.6,"blue"],[1,"darkblue"]],zmin:0,zmax:10,x:eh.slice(2,13),y:n.reverse(),z:[[4,4,3,4,5,3,2,2,3,2],[4,4,3,4,5,4,4,2,4,5],[2,3,3,4,1,5,4,3,2,4],[5,5,5,4,5,5,4,5,4,5]].reverse(),type:"heatmap"}],i={height:20*n.length+100,margin:{t:5},pad:0};if(void 0!==t&&t)try{await t.newPlot(e,o,i,{displayModeBar:!1})}catch(e){console.error("Error creating rest time chart:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}function ev(e="Topics",t=ea,n=X,o=Q,i=Z,r=a){try{t("sunburst","sunburst_text",e),n(),o(),i("#random-eulogy-role"),r("#random-blog-posts",async()=>await ed())}catch(e){console.error("Error loading auto-generated sunburst:",e)}}if("undefined"!=typeof window&&window["@algolia/autocomplete-js"]){let n=window["@algolia/autocomplete-js"];e=n.autocomplete,t=n.getAlgoliaResults}function ek({item:e,createElement:t}){return t("div",{dangerouslySetInnerHTML:{__html:function(e){try{let t=e.url;e.anchor&&(t+=`#${e.anchor}`);let n=e._highlightResult;n||console.log("No Highlight",e);let o=n.title.value,i=n?.content?.value??"";return`
