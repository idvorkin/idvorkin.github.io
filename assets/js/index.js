...
`);let g=encodeURIComponent(m);return`${s}/issues/new?title=${c}&body=${g}`}(n,t.textContent||"",r,l,t);window.open(a,"_blank"),M(e)},a=e.querySelector(".github-issue-submit");a&&(a.addEventListener("click",l),o.push(()=>a.removeEventListener("click",l)));let s=e.querySelector(".github-issue-title"),c=e.querySelector(".github-issue-comment"),d=e=>{(e.ctrlKey||e.metaKey)&&"Enter"===e.key&&(e.preventDefault(),l())};s&&(s.addEventListener("keydown",d),o.push(()=>s.removeEventListener("keydown",d))),c&&(c.addEventListener("keydown",d),o.push(()=>c.removeEventListener("keydown",d)));let u=O.get(t)||[];O.set(t,[...u,...o])}(o,e,n)),o),e)};i.addEventListener("click",s),r.push(()=>i.removeEventListener("click",s));let c=t=>{let n=H.get(e);!n||n.contains(t.target)||t.target===i||i.contains(t.target)||"none"===n.style.display||M(n)},d=setTimeout(()=>{document.addEventListener("click",c,!0),r.push(()=>document.removeEventListener("click",c,!0))},100);r.push(()=>clearTimeout(d)),e.appendChild(o),e.appendChild(i);let u=()=>{o.style.opacity="1",i.style.opacity="1"},p=()=>{o.style.opacity="0",i.style.opacity="0"};e.addEventListener("mouseenter",u),e.addEventListener("mouseleave",p),r.push(()=>{e.removeEventListener("mouseenter",u),e.removeEventListener("mouseleave",p)}),O.set(e,r),j.add(e)}(e,t)}let R=!1;function q(e=0){if("undefined"==typeof document)return;if(console.log("\uD83D\uDDBC️ Enabling image zoom functionality"),void 0===window.GLightbox){if(e<50){console.warn(`\u{26A0}\u{FE0F} GLightbox not found, retrying in 100ms (attempt ${e+1}/50)`),setTimeout(()=>q(e+1),100);return}console.error(`\u{274C} GLightbox failed to load after ${5} seconds, aborting image zoom initialization`);return}let t=document.querySelectorAll("p img, li img, .container img, .post-content img, article img, .markdown-body img, main img");console.log(`\u{1F50D} Found ${t.length} images to process`);let n=0;t.forEach((e,t)=>{if(e.parentElement?.tagName==="A"){console.log(`\u{23ED}\u{FE0F} Skipping image ${t+1} - already wrapped`);return}if(e.naturalWidth>0&&e.naturalWidth<100&&e.naturalHeight<100){console.log(`\u{23ED}\u{FE0F} Skipping image ${t+1} - too small (${e.naturalWidth}x${e.naturalHeight})`);return}let o=document.createElement("a");o.href=e.src,o.className="glightbox",o.setAttribute("data-gallery","post-images"),e.alt&&o.setAttribute("data-description",e.alt),e.parentNode?.insertBefore(o,e),o.appendChild(e),n++,console.log(`\u{2705} Processed image ${t+1}: ${e.src.substring(e.src.lastIndexOf("/")+1)}`)});try{window.GLightbox({selector:".glightbox",touchNavigation:!0,loop:!0,autoplayVideos:!0}),n>0?console.log(`\u{1F389} Image zoom enabled for ${n} images`):console.log("ℹ️ No images needed processing, but GLightbox initialized for existing elements")}catch(e){console.error("Error initializing GLightbox:",e)}}"undefined"!=typeof document&&("loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>q()):setTimeout(()=>q(),500));let U=null;function G(e=0){if("undefined"==typeof document)return;if(console.log("\uD83D\uDCCA Enabling chart zoom functionality"),void 0===window.Chart){if(e<50){console.warn(`\u{26A0}\u{FE0F} Chart.js not found, retrying in 100ms (attempt ${e+1}/50)`),setTimeout(()=>G(e+1),100);return}console.log("ℹ️ Chart.js not found, skipping chart zoom initialization");return}let t=document.querySelectorAll("canvas");console.log(`\u{1F50D} Found ${t.length} canvas elements to check`);let n=0;t.forEach((e,t)=>{var o;let i=window.Chart.getChart(e);if(!i){console.log(`\u{23ED}\u{FE0F} Skipping canvas ${t+1} - no Chart.js instance found`);return}console.log(`\u{1F4C8} Processing Chart.js chart ${t+1}: ${e.id||"unnamed"}`),(o=e).style.width="50%",o.style.maxWidth="400px",o.style.height="auto",o.style.borderRadius="4px",o.style.border="1px solid #e0e0e0",e.style.cursor="pointer",e.addEventListener("click",()=>(function(e,t){if(console.log("\uD83D\uDD0D Opening chart zoom modal"),U){console.log("⚠️ Modal already open, ignoring click");return}let n=document.createElement("div");n.className="chart-zoom-modal",n.style.cssText=`
  ...
  `;let i=document.createElement("button");i.innerHTML="×",i.style.cssText=`
    ...
    color: #666;
    z-index: 10000;
  `,i.addEventListener("click",W);let r=document.createElement("canvas");r.style.cssText=`
    width: 100%;
    max-width: 800px;
    height: auto;
    display: block;
  `,o.appendChild(i),o.appendChild(r),n.appendChild(o),document.body.appendChild(n);let l=JSON.parse(JSON.stringify(e.config));l.options||(l.options={}),l.options.responsive||(l.options.responsive=!0),l.options.maintainAspectRatio||(l.options.maintainAspectRatio=!0),U={originalChart:e,modalChart:new window.Chart(r,l),originalCanvas:t,modalCanvas:r,modalContainer:n},n.addEventListener("click",e=>{e.target===n&&W()}),document.addEventListener("keydown",J),document.body.style.overflow="hidden",console.log("✅ Chart zoom modal opened")})(i,e)),e.addEventListener("mouseenter",()=>{e.style.boxShadow="0 4px 8px rgba(0,0,0,0.2)",e.style.transform="scale(1.02)",e.style.transition="all 0.2s ease"}),e.addEventListener("mouseleave",()=>{e.style.boxShadow="none",e.style.transform="scale(1)"}),n++,console.log(`\u{2705} Processed chart ${t+1}: ${e.id||"unnamed"} - now clickable for zoom`)}),n>0?console.log(`\u{1F389} Chart zoom enabled for ${n} charts`):console.log("ℹ️ No Chart.js charts found to process")}function W(){U&&(console.log("\uD83D\uDD0D Closing chart zoom modal"),U.modalChart&&U.modalChart.destroy(),U.modalContainer&&U.modalContainer.remove(),document.removeEventListener("keydown",J),document.body.style.overflow="",U=null,console.log("✅ Chart zoom modal closed"))}function J(e){"Escape"===e.key&&W()}"undefined"!=typeof document&&("loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{setTimeout(()=>G(),1e3)}):setTimeout(()=>G(),1e3));let X=!0;function Q(){let e=$(".ui-toc-dropdown .toc"),t=$(".expand-toggle");if(0===e.length||0===t.length){console.warn("TOC or toggle elements not found for expand/collapse");return}X?(e.addClass("expand"),t.text("Collapse all")):(e.removeClass("expand"),t.text("Expand all"))}function K(){let e=$("#right-sidebar"),t=$("#main-content");e.length>0&&(e.removeClass(),e.addClass("col-4 pl-0")),t.length>0&&(t.removeClass(),t.addClass("col-8 pr-0"));let n=$("#id-ui-toc-dropdown");n.length>0&&(n.removeClass(),n.addClass("d-none"))}function V(e,t){let n=$(`#${e}`);if(0===n.length){console.warn(`Target element #${e} not found for TOC generation`);return}if(n.html(""),0===$("#content-holder").length){console.warn("Content holder not found for TOC generation");return}new window.Toc("content-holder",{level:3,top:-1,class:"toc",ulClass:"nav",targetId:e}),"undefined"===n.text()&&n.html("");let o=$('<div class="toc-menu"></div'),i=$('<a class="expand-toggle" href="#">Collapse all</a>'),r=$('<a class="back-to-top" href="#">Top of page</a>'),l=$('<a class="go-to-bottom" href="#">Bottom of page</a>'),a=$('<a class="go-to-bottom" href="#">Pin ToC</a>');Q(),i.click(e=>{e.preventDefault(),e.stopPropagation(),X=!X,Q()}),r.click(e=>{e.preventDefault(),e.stopPropagation(),window.scrollTo(0,0)}),l.click(e=>{e.preventDefault(),e.stopPropagation(),window.scrollTo(0,document.body.scrollHeight)}),a.click(e=>K()),o.append(i).append(r).append(l),t&&o.append(a),n.append(o)}async function Y(e){let t,o,i;try{if(!e){console.log("No backlinks available");return}if(!e[t=new URL(document.URL).pathname]){console.log(`Page ${t} not found in backlinks`);return}if(o=e[t]?.incoming_links,i=e[t]?.outgoing_links,!o&&!i){console.log(`No backlinks for the page ${t}`);return}}catch(e){console.log(`Error processing links: ${e instanceof Error?e.message:String(e)}`);return}let r=$("#links-to-page");if(!r||0===r.length){console.log("No back_link_location");return}r.append(`
...
`);let l=r.find("#incoming"),a=(t,n)=>Number(e[n].doc_size)-Number(e[t].doc_size);if(o)for(let t of o.sort(a)){let o=e[t];l.append(n(o))}let s=[];for(let t of i)e[t]&&s.push(t);let c=r.find("#outgoing");if(s)for(let t of s.sort(a)){let o=e[t];c.append(n(o))}let d=r.find("#graph"),u=t.replace(/\//g,"");d.append(`<a href='/graph#${u}'>${t} (${u}) </a>`)}function Z(e,t){let n=e?.attr?e.attr("href"):"unknown";return`<span class='text-danger'>Error: Invalid link for ${n} ${t} </span>`}async function ee(){let e="__idvorkin_add_link_loader_initialized__";window[e]||(window[e]=!0,Y(await s()),function(e){if(!e){console.log("No backlinks data available");return}try{let t=$.makeArray($(".summary-link"));if(!t||0===t.length){console.log("No summary links found");return}for(let n of t){let t=$(n);try{if(!t||!t.attr){console.log("Invalid link element");return}let n=t.attr("href");if(!n){t.html(Z(t,"missing href"));return}if(!e.redirects||!e.url_info){t.html(Z(t,"incomplete backLinks data"));return}if(void 0!==e.redirects[n]&&(n=e.redirects[n]),void 0===e.url_info[n]){t.html(Z(t,"not found in url info"));return}t.html(function(e,t){if(!t)return Z(e,"URL info is undefined");let n=t.url||"#",o=t.title||"Untitled",i=t.description||"No description available",r=`(From:<a href='${n}'> ${o}</a>)`;return`<div>
        <i> ${i}</i> ${r}
    </div>`}(t,e.url_info[n]))}catch(e){t?.html?t.html(Z(t,e)):console.error("Error processing link and unable to display error:",e)}}}catch(e){console.error("Error processing summary links:",e)}}(await en()))}let et=null;async function en(){try{if(null!=et)return et;let e=window.location.href.includes("https://idvork.in"),t="";t=e?"https://raw.githubusercontent.com/idvorkin/idvorkin.github.io/master/back-links.json?flush_cache=True":"/back-links.json";try{let e=await $.getJSON(t);return e.redirects||(e.redirects={}),e.url_info||(e.url_info={}),et=e}catch(e){return console.error("Error fetching backlinks JSON:",e),{redirects:{},url_info:{}}}}catch(e){return console.error("Error in get_back_links:",e),{redirects:{},url_info:{}}}}function eo(){let e=window.Mousetrap();e.bind("s",e=>void(window.location.href="/")),e.bind("t",e=>K()),e.bind("p",e=>(function(){let e=window.location.href,t="https://idvork.in",n=window.location.port||"4000",o=`http://localhost:${n}`,i=e.includes(t),r=e;r=i?e.replace(t,o):e.replace(/http:\/\/localhost:\d+/,t),window.location.href=r})()),e.bind("a",e=>{location.href="/all"}),e.bind("m",e=>{location.href="/toc"}),e.bind("6",e=>{location.href="/ig66"});let t=`
Try these shortcuts:
  s - search
  ...
  m - global toc
  6 - family journal
  `;e.bind("?",e=>alert(t))}function ei(){!function(e){for(let[t,n]of Object.entries(e)){let e="undefined"!=typeof $&&$.fn?$(`a[href=${t}]`).first()[0]:document.querySelector(`a[href="${t}"]`);if(!e)return;let o=n.cloneNode(!0);o.children.length>0&&o.children[0].remove(),e.replaceWith(o),n.remove()}}(function(){let e={};for(let t of"undefined"!=typeof $&&$.fn?$("ul").toArray():Array.from(document.querySelectorAll("ul"))){let n=t.firstElementChild;if(!n)continue;let o=n.textContent;o&&o.startsWith("l")&&(Number.isNaN(Number.parseInt(o.substring(1)))||(e[o]=t))}return e}())}function er(){let e="__idvorkin_load_globals_initialized__";window[e]||(window[e]=!0,$(ee),$(eo),"undefined"!=typeof $&&$.fn&&$.fn.ready?$(document).ready(ei):"undefined"!=typeof document&&("loading"===document.readyState?document.addEventListener("DOMContentLoaded",ei):ei()),function(e="recent-posts",t=document){"loading"===t.readyState?t.addEventListener("DOMContentLoaded",()=>{h(e)}):h(e)}(),document.getElementById("last-modified-posts")&&f(),$(()=>{V("ui-toc",!0),V("ui-toc-affix",!1)}),function(e={}){R||(R=!0,function(){let e="header-copy-link-styles";if(document.getElementById(e))return;let t=document.createElement("style");t.id=e,t.textContent=`
    .header-copy-link,
    .header-github-issue {
      opacity: 0;
      margin-left: 0.5rem;
  ...
  `,document.head.appendChild(t)}(),"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{P(e)}):P(e))}(),q(),G(),function(){if("localhost"!==window.location.hostname&&"127.0.0.1"!==window.location.hostname){console.log("Not on dev server, skipping dev info");return}console.log("Dev server detected, initializing dev info...");let e=function(){let e=window.__GIT_BRANCH__;return e?(console.log("Branch from global variable:",e),e):(console.log("Branch info not found"),null)}(),t=window.location.port||"80";if(console.log("Dev info - Branch:",e,"Port:",t),e&&"main"!==e||"4000"!==t){let n=document.createElement("div");n.id="dev-info-banner",n.style.cssText=`
      position: fixed;
      top: 60px;
      left: 0;
      right: 0;
   ...
   `;return""!==e.thumbnail?(console.log(e.title),console.log(i),t.append(`
      ...
      ${r}
      </div>`)):t.append(r),t.html()}function ea(e){if(console.log("Processing",e.length,"posts"),!e){console.log("No posts being imported");return}l("#random-post",()=>el(o(e))),l("#achievment",()=>el(o(e.filter(e=>e.title.toLowerCase().includes("achievement"))))),l("#random-recent",()=>el(o(e.filter(e=>e.tags.includes("family-journal")))))}function es(){$.getJSON("/ig66/ig66-export.json",ea)}function ec(e){$.getJSON("/eulogy.json",t=>(function(e,t){if(!t){console.log("No roles being imported");return}console.log("Processing",t.roles.length,"roles"),l(e,()=>(function(e){let t=e.title.replace(/ /g,"%20"),n=["igor","ammon"],o=n[Math.floor(Math.random()*n.length)];return`
  <div>
  ...
  `})(o(t.roles)))})(e,t))}"undefined"!=typeof $&&$.fn&&$.fn.ready?$(document).ready(er):"undefined"!=typeof document&&("loading"===document.readyState?document.addEventListener("DOMContentLoaded",er):er());class ed{constructor({name:e,value:t=25,children:n=[]}){this.name=e,this.children=i(n),this.value=t}}function eu(e=em,t=ep){let n=e();for(let e of n.keys())t(e,n.get(e))}function ep(e,t,n=$,i=l){let r=n('<div class="alert alert-primary" role="alert"/>');n(e).after(r),i(r,()=>`<span>${o(t)}</span><span style="float: right; cursor: pointer;" title="Click for another prompt">\u{1F504}</span>`)}function em(e=$){let t=e("h3").first(),n=t,o=[],i=new Map;for(let r=t;0!==r.length;r=e(r).next()){if("H3"===r.prop("tagName")){i.set(n,o),n=r,o=[];continue}"UL"===r.prop("tagName")&&(o=Array.from(e(r).find("li")).map(t=>e(t).text()))}return i.set(n,o),i}function*eg(e){if(!e)return;let t=[];for(t.push([e,null]);t.length>0;){let[e,n]=t.shift();for(let n of e.children??[])t.push([n,e]);yield[e,n]}}function ef(e=em){return new Map(Array.from(e().entries()).map(([e,t],n)=>[e.text(),t]))}function eh(e,t,n){let i=Array.from(eg(t)).find(([t,n])=>t.name===e);if(!i)return"Click in any box or circle";let[r,l]=i,a=Array.from(eg(r)).map(([e,t])=>e).filter(e=>{let t=n.has(e.name),o=n.has(`${e.name}\u{1F517}`);return t||o}).flatMap(e=>(n.get(e.name)||n.get(`${e.name}\u{1F517}`)||[]).map(t=>`${e.name}: ${t}`));return 0===a.length?"Click in any box or circle":o(a)}async function eb(e,t,n,o=$,i=Plotly){if(!i){console.error("Plotly is not available");return}let r=function(e){let t=Array.from(eg(e)).map(([e,t])=>[e.name,t?.name]);return{ids:t.map(([e,t])=>e),labels:t.map(([e,t])=>e),parents:t.map(([e,t])=>t)}}(n),l={type:"sunburst",outsidetextfont:{size:20,color:"#377eb8"},hoverinfo:"none",marker:{line:{width:2}},maxdepth:2,displayModeBar:!1};Object.assign(l,r),l.values=void 0;try{await i.newPlot(e,[l],{margin:{l:0,r:0,b:0,t:0},sunburstcolorway:["#636efa","#ef553b","#00cc96"]},{displayModeBar:!1});let r=e=>{o(`#${t}`).text(e)};o(`#${t}`).first().click(()=>{let e=o("#sunburst text:first").text(),t=eh(e,n,ef());r(t)});let a=document.getElementById(e);return a&&"function"==typeof a.on&&a.on("plotly_click",e=>{if(e?.points?.[0]){let t=e.points[0].label,o=eh(t,n,ef());r(o)}}),a}catch(e){return console.error("Failed to create sunburst plot:",e),null}}async function ey(e,t,n="Root",o=null,i=$,r=Plotly){return eb(e,t,function(e="Root",t=null,n=$){let o=t?n(t).find("h2"):n("h2"),i=[];return o.each((e,t)=>{let o=n(t),r=o.text().trim();if(!r)return;let l=[],a=o.next();for(;a.length>0&&"H2"!==a.prop("tagName");){if("H3"===a.prop("tagName")){let e=a.text().trim();e&&l.push(new ed({name:e}))}a=a.next()}l.length>0&&i.push(new ed({name:r,children:l}))}),new ed({name:e,children:i})}(n,o,i),i,r)}class e${get_tree(){return new ed({name:"7H ",children:[new ed({name:""}),new ed({name:"Be Proactive"}),new ed({name:"Begin with the end in mind"}),new ed({name:"First things First"}),new ed({name:"Think Win/Win"}),new ed({name:"First Understand"}),new ed({name:"Synergize"}),new ed({name:"Sharpen the Saw"})]})}}class ev{get_tree(){let e=new ed({name:"Health",children:[{name:"Physical"},{name:"Emotional"},{name:"Cognative"}],value:31}),t=new ed({name:"Magic",children:[new ed({name:"Card Magic"}),new ed({name:"Coin Magic"}),new ed({name:"Band Magic"})]}),n=new ed({name:"Hobbies",children:[new ed({name:"Biking"}),new ed({name:"Tech"}),new ed({name:"Juggling"})]}),o=new ed({name:"Relationships",children:[new ed({name:"Zach"}),new ed({name:"Amelia"}),new ed({name:"Tori"}),new ed({name:"Friends"})]}),i=new ed({name:"Joy",children:[new ed({name:"Balloons"}),new ed({name:"Joy to Others"})]});return new ed({name:"Invest in",children:[e,t,n,o,i]})}}function ew({url:e,title:t,description:n}){let o=`<a href='${e}'}>${t}</a>`,i=`audio_player_${Math.floor(1e10*Math.random())}`,r=e.replace(/\//g,"_");return`
    <div>
        <audio id='${i}'>
  ...
  `}async function ex(e=s,t=o){try{let n=await e(),o=Object.entries(n).map(e=>e[1]),i=t(o);return ew({url:i.url,title:i.title,description:i.description})}catch(e){return console.error("Error generating random post HTML:",e),"<div>Could not load random post</div>"}}function ek(e="#e1",t="#e2",n="#e3",o=ec){try{o(e),o(t),o(n)}catch(e){console.error("Error loading random eulogy:",e)}}function eE(e=eb,t=eu,n=es,o=ec,i=l){try{e("sunburst","sunburst_text",new ev().get_tree()),t(),n(),o("#random-eulogy-role"),i("#random-blog-posts",async()=>await ex())}catch(e){console.error("❌ Error loading enjoy page:",e)}}function e_(e=eb,t=eu){try{e("sunburst","sunburst_text",new e$().get_tree()),t()}catch(e){console.error("Error loading 7 habits page:",e)}}function eC(e=es){try{e()}catch(e){console.error("Error loading IG66 page:",e)}}function eL(e=eI,t=eM,n=eN){try{e("balance-heatmap-rest"),t("balance-heatmap-work"),n("balance-radar-map-ideal")}catch(e){console.error("Error loading balance page:",e)}}let eS=["Jan","Feb","Mar","Apr","May","June","July","Aug","Sep","Oct","Nov","Dec"],eT="#00BF00";async function eN(e,t){if(void 0!==t&&t)try{await t.newPlot(e,[{type:"scatterpolar",r:[8,8,8,5,8,8,8],theta:["Work","Tech","Health","Hobbies","Relationships","Magic","Work"],name:"2020 Goal",fill:"toself"},{type:"scatterpolar",r:[7,7,5,5,5,9,7],theta:["Work","Tech","Health","Hobbies","Relationships","Magic","Work"],name:"2020 Actual",fill:"toself"}],{polar:{radialaxis:{visible:!0,range:[0,10]}},showlegend:!0},{displayModeBar:!1})}catch(e){console.error("Error creating radar map:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}async function eM(e,t){let n=["Tech","Work"],o={height:20*n.length+100,margin:{t:5},pad:0},i=[{colorscale:[[0,"darkblue"],[.4,"blue"],[.5,eT],[.6,"darkred"],[1,"red"]],zmin:0,zmax:10,x:eS.slice(2,13),y:n,z:[[7,4,7,8,2,4,2,3,2,8],[10,7,5,5,3,5,6,6,7,5]],type:"heatmap"}];if(void 0!==t&&t)try{await t.newPlot(e,i,o,{displayModeBar:!1})}catch(e){console.error("Error creating work balance chart:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}async function eI(e,t){let n=["Health","Hobbies","Family","Magic"],o=[{colorscale:[[0,"red"],[.4,"darkred"],[.5,eT],[.6,"blue"],[1,"darkblue"]],zmin:0,zmax:10,x:eS.slice(2,13),y:n.reverse(),z:[[4,4,3,4,5,3,2,2,3,2],[4,4,3,4,5,4,4,2,4,5],[2,3,3,4,1,5,4,3,2,4],[5,5,5,4,5,5,4,5,4,5]].reverse(),type:"heatmap"}],i={height:20*n.length+100,margin:{t:5},pad:0};if(void 0!==t&&t)try{await t.newPlot(e,o,i,{displayModeBar:!1})}catch(e){console.error("Error creating rest time chart:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}function eD(e="Topics",t=ey,n=eu,o=es,i=ec,r=l){try{t("sunburst","sunburst_text",e),n(),o(),i("#random-eulogy-role"),r("#random-blog-posts",async()=>await ex())}catch(e){console.error("Error loading auto-generated sunburst:",e)}}if("undefined"!=typeof window&&window["@algolia/autocomplete-js"]){let n=window["@algolia/autocomplete-js"];e=n.autocomplete,t=n.getAlgoliaResults}function ez(e){let t=document.createElement("div");return t.textContent=e||"",t.innerHTML}function eA(e){if(!e)return!1;if(e.startsWith("/"))return!0;try{let t=new URL(e);return"http:"===t.protocol||"https:"===t.protocol}catch{return!1}}function eF({item:e,createElement:t}){return t("div",{dangerouslySetInnerHTML:{__html:function(e){try{let t=e.url;if(e.anchor&&(t+=`#${e.anchor}`),!eA(t))return console.warn("Invalid URL skipped in InstantSearchHitTemplate:",t),"<div>Invalid result</div>";let n=e._highlightResult;n||console.log("No Highlight",e);let o=n.title.value,i=n?.content?.value??"";return`
           <span data-url="${ez(t)}" style="cursor: pointer;">
              <b> <a href="${ez(t)}">${o}</a></b> <span>${i}</span>
           </span>
        `}catch(t){console.log("Error in hitTemplate",t,e)}return"invalid HTML"}(e)}})}async function eB(){let e=performance.now(),t=await s(),n=performance.now()-e;console.log(`  \u{1F4CA} [get_random_post] Loaded links in ${n.toFixed(0)}ms`);let i=o(Object.entries(t).map(e=>e[1]));return{title:i.title,url:i.url,description:i.description}}async function eO(e=4){let t=performance.now(),n=await s(),o=performance.now()-t;console.log(`  \u{1F4CA} [get_random_posts_batch] Loaded links once in ${o.toFixed(0)}ms`);let i=Object.entries(n).map(e=>e[1]),r=[],l=new Set;for(;r.length<e&&r.length<i.length;){let e=Math.floor(Math.random()*i.length);if(!l.has(e)){l.add(e);let t=i[e];r.push({title:t.title,url:t.url,description:t.description})}}return r}async function eH(e=4){try{let t=performance.now(),n=await s(),o=performance.now()-t;return console.log(`  \u{1F4CA} [get_recent_posts] Loaded links in ${o.toFixed(0)}ms`),Object.entries(n).map(([e,t])=>({url:e,title:t.title||e,description:t.description||"",doc_size:t.doc_size||0,last_modified:t.last_modified||""})).filter(e=>e.description&&""!==e.description.trim()&&e.title&&""!==e.title.trim()).sort((e,t)=>e.last_modified&&t.last_modified?new Date(t.last_modified).getTime()-new Date(e.last_modified).getTime():t.doc_size-e.doc_size).slice(0,e)}catch(e){return console.error("❌ Error loading recent posts:",e),[]}}async function ej(e=3){return{sourceId:"random_posts",async getItems(){let t=Array(e).join("_").split("_");return await Promise.all(t.map(async e=>{try{return await eB()}catch(e){return console.error("Error getting random post:",e),{url:"",title:"Error",description:"Failed to load post"}}}))},getItemUrl:({item:e})=>e.url,templates:{item:({item:e,createElement:t})=>eA(e.url)?t("div",{dangerouslySetInnerHTML:{__html:`
            <span data-url="${ez(e.url)}" style="cursor: pointer;">
           <b> <a href="${ez(e.url)}">${ez(e.title)}</a></b>
            <span>${ez(e.description)}</span>
            </span>
            `}}):(console.warn("Invalid URL skipped in GetRandomSearchResults:",e.url),t("div",{dangerouslySetInnerHTML:{__html:"<div>Invalid result</div>"}})),header:({createElement:e})=>e("div",{dangerouslySetInnerHTML:{__html:"<i style='color:grey'>Random posts ...</i>"}})}}}async function eP(e=4){return{sourceId:"recent_posts",getItems:async()=>await eH(e),getItemUrl:({item:e})=>e.url,templates:{item:({item:e,createElement:t})=>eA(e.url)?t("div",{dangerouslySetInnerHTML:{__html:`
            <span data-url="${ez(e.url)}" style="cursor: pointer;">
           <b> <a href="${ez(e.url)}">${ez(e.title)}</a></b>
            <span>${ez(e.description)}</span>
            </span>
            `}}):(console.warn("Invalid URL skipped in GetRecentSearchResults:",e.url),t("div",{dangerouslySetInnerHTML:{__html:"<div>Invalid result</div>"}})),header:({createElement:e})=>e("div",{dangerouslySetInnerHTML:{__html:"<i style='color:grey'>Recent posts ...</i>"}})}}}async function eR(n,o,i,r,l,a=3,s=4,c=3){if(!e){console.error("Autocomplete is not defined");return}let d=algoliasearch(n,o),u=await ej(c),p=await eP(s),m=r.startsWith("#")?r:`#${r}`;if(0===$(m).length){console.log("No autocomplete element found","autocomplete_id",r);return}return e({container:m,placeholder:"Search Igor's Musings ...",getSources:function({query:e}){let n=0===e.length;n&&(e=" ");let o=function(e,n,o,i=3,r=!1){let l="NOT tags:family-journal";return r&&(l=""),{sourceId:"featured_posts",getItems:()=>t?t({searchClient:e,queries:[{indexName:n,query:o,filters:l,params:{hitsPerPage:i,highlightPreTag:"<span style='background:yellow'>",highlightPostTag:"</span>"}}]}):(console.error("getAlgoliaResults is not defined"),[]),templates:{item:eF,header:({createElement:e})=>e("div",{dangerouslySetInnerHTML:{__html:"<i style='color:grey'>Featured posts ...</i>"}})},getItemUrl({item:e}){let t=e.url;return e.anchor&&(t+=`#${e.anchor}`),t}}}(d,i,e,n?a:10,l);return n?[o,p,u]:[o]},debug:!1,openOnFocus:!0,detachedMediaQuery:""})}$(document).ready(()=>{r(er);let e=()=>{let e=$("#search-box");e.length>0&&e.focus()};"undefined"!=typeof Mousetrap&&Mousetrap.bind("s",()=>e()),$("#toc-content").length>0&&console.log("TOC initialized"),$("#search-box").length>0&&console.log("Search initialized");let t=["item1","item2","item3"];console.log("Random item:",o(t)),console.log("Shuffled items:",i([...t])),s().then(e=>{console.log("Links loaded, count:",Object.keys(e).length)}),console.log("Blog JavaScript initialized")});export{o as random_from_list,i as shuffle,l as append_randomizer_div,r as defer,s as get_link_info,c as get_random_page_url,er as load_globals,n as MakeBackLinkHTML,eR as CreateAutoComplete,eB as get_random_post,eH as get_recent_posts,eO as get_random_posts_batch,f as initRecentAllPosts,eu as add_random_prompts,eb as add_sunburst,ey as add_sunburst_from_dom,ed as TreeNode,eE as load_enjoy2,e_ as load_7_habits,eD as load_auto_sunburst,ew as makePostPreviewHTML,ex as make_random_post_html,eC as load_ig66,eL as load_balance,ek as load_random_eulogy};
