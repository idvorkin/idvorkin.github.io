...
Try these shortcuts:
  ...
  `,document.head.appendChild(t)}(),"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{D(e)}):D(e))}())}if("undefined"!=typeof $&&$.fn&&$.fn.ready?$(document).ready(W):"undefined"!=typeof document&&("loading"===document.readyState?document.addEventListener("DOMContentLoaded",W):W()),"undefined"!=typeof window&&window["@algolia/autocomplete-js"]){let n=window["@algolia/autocomplete-js"];e=n.autocomplete,t=n.getAlgoliaResults}function G({item:e,createElement:t}){return t("div",{dangerouslySetInnerHTML:{__html:function(e){try{let t=e.url;e.anchor&&(t+=`#${e.anchor}`);let n=e._highlightResult;n||console.log("No Highlight",e);let o=n.title.value,r=n?.content?.value??"";return`
   ...
   `;return""!==e.thumbnail?(console.log(e.title),console.log(r),t.append(`
      ...
      ${i}
      </div>`)):t.append(i),t.html()}function el(e){if(console.log("Processing",e.length,"posts"),!e){console.log("No posts being imported");return}a("#random-post",()=>ea(o(e))),a("#achievment",()=>ea(o(e.filter(e=>e.title.toLowerCase().includes("achievement"))))),a("#random-recent",()=>ea(o(e.filter(e=>e.tags.includes("family-journal")))))}function es(){$.getJSON("/ig66/ig66-export.json",el)}function ec(e){$.getJSON("/eulogy.json",t=>(function(e,t){if(!t){console.log("No roles being imported");return}console.log("Processing",t.roles.length,"roles"),a(e,()=>(function(e){let t=e.title.replace(/ /g,"%20"),n=["igor","ammon"],o=n[Math.floor(Math.random()*n.length)];return`
  <div>
  ...
  `}async function ef(e=s,t=o){try{let n=await e(),o=Object.entries(n).map(e=>e[1]),r=t(o);return ep({url:r.url,title:r.title,description:r.description})}catch(e){return console.error("Error generating random post HTML:",e),"<div>Could not load random post</div>"}}function eg(e="#e1",t="#e2",n="#e3",o=ec){try{o(e),o(t),o(n)}catch(e){console.error("Error loading random eulogy:",e)}}function em(e=ei,t=X,n=es,o=ec,r=a){try{e("sunburst","sunburst_text",new eu().get_tree()),t(),n(),o("#random-eulogy-role"),r("#random-blog-posts",async()=>await ef())}catch(e){console.error("❌ Error loading enjoy page:",e)}}function eh(e=ei,t=X){try{e("sunburst","sunburst_text",new ed().get_tree()),t()}catch(e){console.error("Error loading 7 habits page:",e)}}function ey(e=es){try{e()}catch(e){console.error("Error loading IG66 page:",e)}}function eb(e=e_,t=ek,n=ev){try{e("balance-heatmap-rest"),t("balance-heatmap-work"),n("balance-radar-map-ideal")}catch(e){console.error("Error loading balance page:",e)}}let e$=["Jan","Feb","Mar","Apr","May","June","July","Aug","Sep","Oct","Nov","Dec"],ew="#00BF00";async function ev(e,t){if(void 0!==t&&t)try{await t.newPlot(e,[{type:"scatterpolar",r:[8,8,8,5,8,8,8],theta:["Work","Tech","Health","Hobbies","Relationships","Magic","Work"],name:"2020 Goal",fill:"toself"},{type:"scatterpolar",r:[7,7,5,5,5,9,7],theta:["Work","Tech","Health","Hobbies","Relationships","Magic","Work"],name:"2020 Actual",fill:"toself"}],{polar:{radialaxis:{visible:!0,range:[0,10]}},showlegend:!0},{displayModeBar:!1})}catch(e){console.error("Error creating radar map:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}async function ek(e,t){let n=["Tech","Work"],o={height:20*n.length+100,margin:{t:5},pad:0},r=[{colorscale:[[0,"darkblue"],[.4,"blue"],[.5,ew],[.6,"darkred"],[1,"red"]],zmin:0,zmax:10,x:e$.slice(2,13),y:n,z:[[7,4,7,8,2,4,2,3,2,8],[10,7,5,5,3,5,6,6,7,5]],type:"heatmap"}];if(void 0!==t&&t)try{await t.newPlot(e,r,o,{displayModeBar:!1})}catch(e){console.error("Error creating work balance chart:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}async function e_(e,t){let n=["Health","Hobbies","Family","Magic"],o=[{colorscale:[[0,"red"],[.4,"darkred"],[.5,ew],[.6,"blue"],[1,"darkblue"]],zmin:0,zmax:10,x:e$.slice(2,13),y:n.reverse(),z:[[4,4,3,4,5,3,2,2,3,2],[4,4,3,4,5,4,4,2,4,5],[2,3,3,4,1,5,4,3,2,4],[5,5,5,4,5,5,4,5,4,5]].reverse(),type:"heatmap"}],r={height:20*n.length+100,margin:{t:5},pad:0};if(void 0!==t&&t)try{await t.newPlot(e,o,r,{displayModeBar:!1})}catch(e){console.error("Error creating rest time chart:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}$(document).ready(()=>{i(W);let e=()=>{let e=$("#search-box");e.length>0&&e.focus()};"undefined"!=typeof Mousetrap&&Mousetrap.bind("s",()=>e()),$("#toc-content").length>0&&console.log("TOC initialized"),$("#search-box").length>0&&console.log("Search initialized");let t=["item1","item2","item3"];console.log("Random item:",o(t)),console.log("Shuffled items:",r([...t])),s().then(e=>{console.log("Links loaded, count:",Object.keys(e).length)}),console.log("Blog JavaScript initialized")});export{o as random_from_list,r as shuffle,a as append_randomizer_div,i as defer,s as get_link_info,W as load_globals,n as MakeBackLinkHTML,Z as CreateAutoComplete,g as initRecentAllPosts,X as add_random_prompts,ei as add_sunburst,K as TreeNode,em as load_enjoy2,eh as load_7_habits,ep as makePostPreviewHTML,ey as load_ig66,eb as load_balance,eg as load_random_eulogy};
