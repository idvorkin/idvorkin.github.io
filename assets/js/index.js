...
<div>
  ...
  `,n}(n,e.textContent||"");document.body.appendChild(r),i.addEventListener("click",t=>{t.preventDefault(),t.stopPropagation(),function(e,t){document.querySelectorAll(".github-issue-popup").forEach(e=>{e.style.display="none"}),e.style.display="block",e.style.position="absolute",e.style.zIndex="1000";let n=t.getBoundingClientRect(),o=window.pageYOffset||document.documentElement.scrollTop,i=window.pageXOffset||document.documentElement.scrollLeft;e.style.top=n.bottom+o+10+"px",e.style.left=n.left+i+"px";let r=e.querySelector(".github-issue-title");r&&r.focus()}(r,e)});let a=r.querySelector(".github-issue-popup-close");a&&a.addEventListener("click",()=>z(r));let l=r.querySelector(".github-issue-cancel");l&&l.addEventListener("click",()=>z(r));let s=()=>{let t=r.querySelector(".github-issue-title"),o=r.querySelector(".github-issue-comment"),i=t?.value||"",a=o?.value||"",l=function(e,t,n,o,i){let r=window.location.pathname.replace(/^\//,"").replace(/\.html$/,""),a=document.querySelector('meta[property="markdown-path"]'),l=a?a.getAttribute("content"):`${r||"index"}.md`,s="https://github.com/idvorkin/idvorkin.github.io",c=encodeURIComponent(n?`${r||"index"}/${e}: ${n}`:`${r||"index"}/${e}: Issue with ${t}`),d=o||n||`Issue with section: ${t}`,u=i?function(e){let t=e.nextElementSibling;for(;t&&"P"!==t.tagName&&!t.tagName.match(/^H[1-6]$/);)t=t.nextElementSibling;if(t&&"P"===t.tagName){let e=t.textContent||"";return e.length>500?e.substring(0,497)+"...":e}return""}(i):"",p=`\u{1F4CD} [${r||"index"}](https://idvorkin.azurewebsites.net/${r})/[${e}](https://idvorkin.azurewebsites.net/${r}#${e}) - [[Live]](https://idvorkin.azurewebsites.net/${r}#${e}) [[GitHub]](${s}/blob/main/${l}#${e})`,g=`${p}
...
Try these shortcuts:
  ...
  `,document.head.appendChild(t)}(),"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{N(e)}):N(e))}(),H(),function(){if("localhost"!==window.location.hostname&&"127.0.0.1"!==window.location.hostname){console.log("Not on dev server, skipping dev info");return}console.log("Dev server detected, initializing dev info...");let e=function(){let e=window.__GIT_BRANCH__;return e?(console.log("Branch from global variable:",e),e):(console.log("Branch info not found"),null)}(),t=window.location.port||"80";if(console.log("Dev info - Branch:",e,"Port:",t),e&&"main"!==e||"4000"!==t){let n=document.createElement("div");n.id="dev-info-banner",n.style.cssText=`
   ...
   `;return""!==e.thumbnail?(console.log(e.title),console.log(i),t.append(`
      ...
      ${r}
      </div>`)):t.append(r),t.html()}function V(e){if(console.log("Processing",e.length,"posts"),!e){console.log("No posts being imported");return}a("#random-post",()=>K(o(e))),a("#achievment",()=>K(o(e.filter(e=>e.title.toLowerCase().includes("achievement"))))),a("#random-recent",()=>K(o(e.filter(e=>e.tags.includes("family-journal")))))}function Q(){$.getJSON("/ig66/ig66-export.json",V)}function X(e){$.getJSON("/eulogy.json",t=>(function(e,t){if(!t){console.log("No roles being imported");return}console.log("Processing",t.roles.length,"roles"),a(e,()=>(function(e){let t=e.title.replace(/ /g,"%20"),n=["igor","ammon"],o=n[Math.floor(Math.random()*n.length)];return`
  <div>
