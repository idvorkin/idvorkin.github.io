...
Try these shortcuts:
  ...
  `,document.head.appendChild(t)}(),"loading"===document.readyState?document.addEventListener("DOMContentLoaded",()=>{I(e)}):I(e))}(),z())}if("undefined"!=typeof $&&$.fn&&$.fn.ready?$(document).ready(U):"undefined"!=typeof document&&("loading"===document.readyState?document.addEventListener("DOMContentLoaded",U):U()),"undefined"!=typeof window&&window["@algolia/autocomplete-js"]){let n=window["@algolia/autocomplete-js"];e=n.autocomplete,t=n.getAlgoliaResults}function q({item:e,createElement:t}){return t("div",{dangerouslySetInnerHTML:{__html:function(e){try{let t=e.url;e.anchor&&(t+=`#${e.anchor}`);let n=e._highlightResult;n||console.log("No Highlight",e);let o=n.title.value,r=n?.content?.value??"";return`
   ...
   `;return""!==e.thumbnail?(console.log(e.title),console.log(r),t.append(`
      ...
      ${i}
      </div>`)):t.append(i),t.html()}function ec(e){if(console.log("Processing",e.length,"posts"),!e){console.log("No posts being imported");return}a("#random-post",()=>es(o(e))),a("#achievment",()=>es(o(e.filter(e=>e.title.toLowerCase().includes("achievement"))))),a("#random-recent",()=>es(o(e.filter(e=>e.tags.includes("family-journal")))))}function ed(){$.getJSON("/ig66/ig66-export.json",ec)}function eu(e){$.getJSON("/eulogy.json",t=>(function(e,t){if(!t){console.log("No roles being imported");return}console.log("Processing",t.roles.length,"roles"),a(e,()=>(function(e){let t=e.title.replace(/ /g,"%20"),n=["igor","ammon"],o=n[Math.floor(Math.random()*n.length)];return`
  <div>
  ...
  `})(o(t.roles)))})(e,t))}class ep{get_tree(){return new X({name:"7H ",children:[new X({name:""}),new X({name:"Be Proactive"}),new X({name:"Begin with the end in mind"}),new X({name:"First things First"}),new X({name:"Think Win/Win"}),new X({name:"First Understand"}),new X({name:"Synergize"}),new X({name:"Sharpen the Saw"})]})}}class ef{get_tree(){let e=new X({name:"Health",children:[{name:"Physical"},{name:"Emotional"},{name:"Cognative"}],value:31}),t=new X({name:"Magic",children:[new X({name:"Card Magic"}),new X({name:"Coin Magic"}),new X({name:"Band Magic"})]}),n=new X({name:"Hobbies",children:[new X({name:"Biking"}),new X({name:"Tech"}),new X({name:"Juggling"})]}),o=new X({name:"Relationships",children:[new X({name:"Zach"}),new X({name:"Amelia"}),new X({name:"Tori"}),new X({name:"Friends"})]}),r=new X({name:"Joy",children:[new X({name:"Balloons"}),new X({name:"Joy to Others"})]});return new X({name:"Invest in",children:[e,t,n,o,r]})}}function eg({url:e,title:t,description:n}){let o=`<a href='${e}'}>${t}</a>`,r=`audio_player_${Math.floor(1e10*Math.random())}`,i=e.replace(/\//g,"_");return`
    <div>
        <audio id='${r}'>
  ...
  `}async function em(e=s,t=o){try{let n=await e(),o=Object.entries(n).map(e=>e[1]),r=t(o);return eg({url:r.url,title:r.title,description:r.description})}catch(e){return console.error("Error generating random post HTML:",e),"<div>Could not load random post</div>"}}function eh(e="#e1",t="#e2",n="#e3",o=eu){try{o(e),o(t),o(n)}catch(e){console.error("Error loading random eulogy:",e)}}function ey(e=ea,t=ee,n=ed,o=eu,r=a){try{e("sunburst","sunburst_text",new ef().get_tree()),t(),n(),o("#random-eulogy-role"),r("#random-blog-posts",async()=>await em())}catch(e){console.error("❌ Error loading enjoy page:",e)}}function eb(e=ea,t=ee){try{e("sunburst","sunburst_text",new ep().get_tree()),t()}catch(e){console.error("Error loading 7 habits page:",e)}}function e$(e=ed){try{e()}catch(e){console.error("Error loading IG66 page:",e)}}function ew(e=eE,t=ex,n=e_){try{e("balance-heatmap-rest"),t("balance-heatmap-work"),n("balance-radar-map-ideal")}catch(e){console.error("Error loading balance page:",e)}}let ev=["Jan","Feb","Mar","Apr","May","June","July","Aug","Sep","Oct","Nov","Dec"],ek="#00BF00";async function e_(e,t){if(void 0!==t&&t)try{await t.newPlot(e,[{type:"scatterpolar",r:[8,8,8,5,8,8,8],theta:["Work","Tech","Health","Hobbies","Relationships","Magic","Work"],name:"2020 Goal",fill:"toself"},{type:"scatterpolar",r:[7,7,5,5,5,9,7],theta:["Work","Tech","Health","Hobbies","Relationships","Magic","Work"],name:"2020 Actual",fill:"toself"}],{polar:{radialaxis:{visible:!0,range:[0,10]}},showlegend:!0},{displayModeBar:!1})}catch(e){console.error("Error creating radar map:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}async function ex(e,t){let n=["Tech","Work"],o={height:20*n.length+100,margin:{t:5},pad:0},r=[{colorscale:[[0,"darkblue"],[.4,"blue"],[.5,ek],[.6,"darkred"],[1,"red"]],zmin:0,zmax:10,x:ev.slice(2,13),y:n,z:[[7,4,7,8,2,4,2,3,2,8],[10,7,5,5,3,5,6,6,7,5]],type:"heatmap"}];if(void 0!==t&&t)try{await t.newPlot(e,r,o,{displayModeBar:!1})}catch(e){console.error("Error creating work balance chart:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}async function eE(e,t){let n=["Health","Hobbies","Family","Magic"],o=[{colorscale:[[0,"red"],[.4,"darkred"],[.5,ek],[.6,"blue"],[1,"darkblue"]],zmin:0,zmax:10,x:ev.slice(2,13),y:n.reverse(),z:[[4,4,3,4,5,3,2,2,3,2],[4,4,3,4,5,4,4,2,4,5],[2,3,3,4,1,5,4,3,2,4],[5,5,5,4,5,5,4,5,4,5]].reverse(),type:"heatmap"}],r={height:20*n.length+100,margin:{t:5},pad:0};if(void 0!==t&&t)try{await t.newPlot(e,o,r,{displayModeBar:!1})}catch(e){console.error("Error creating rest time chart:",e)}else console.warn("Plotly is not defined, skipping chart rendering")}function eC(e="Topics",t=el,n=ee,o=ed,r=eu,i=a){try{t("sunburst","sunburst_text",e),n(),o(),r("#random-eulogy-role"),i("#random-blog-posts",async()=>await em())}catch(e){console.error("Error loading auto-generated sunburst:",e)}}$(document).ready(()=>{i(U);let e=()=>{let e=$("#search-box");e.length>0&&e.focus()};"undefined"!=typeof Mousetrap&&Mousetrap.bind("s",()=>e()),$("#toc-content").length>0&&console.log("TOC initialized"),$("#search-box").length>0&&console.log("Search initialized");let t=["item1","item2","item3"];console.log("Random item:",o(t)),console.log("Shuffled items:",r([...t])),s().then(e=>{console.log("Links loaded, count:",Object.keys(e).length)}),console.log("Blog JavaScript initialized")});export{o as random_from_list,r as shuffle,a as append_randomizer_div,i as defer,s as get_link_info,U as load_globals,n as MakeBackLinkHTML,K as CreateAutoComplete,g as initRecentAllPosts,ee as add_random_prompts,ea as add_sunburst,el as add_sunburst_from_dom,X as TreeNode,ey as load_enjoy2,eb as load_7_habits,eC as load_auto_sunburst,eg as makePostPreviewHTML,e$ as load_ig66,ew as load_balance,eh as load_random_eulogy};
