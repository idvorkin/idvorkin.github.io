...
tags:
  ...
  - biking
  - health
aliases: ["/bike", "/biking", "/bikes", "bike", "/brompton-toys"]
imagefeaturelocal: raccoon-bike.webp
redirect_from:
  - /biking
  - /bikes
  - /brompton-toys
...
Why the Brompton makes me happy:

- Taking it on buses, subways, ubers, and throwing it in people's trunks.
- Riding it all the time.
- Looking goofy, and all the people who ask me questions about it.
- Telling people to try riding it.

My only wishes: more than 6 gears, and a water bottle holder - for a bike this perfect it's surprising there isn't one.

Brompton accessories that earned their keep:

- **EZ Wheels** - The stock wheels that let you roll the folded Brompton suck. EZ wheels let it roll effortlessly. With a rack you can run 4 of them, which removes much of the need to carry the bike while it's folded.
- **Ergon GP-2 grips** - The stock grips are terrible. Without a rack you can't go bigger than the GP-2s without affecting the fold.
- **Bordo 75cm folding lock** - Secure, and fits on the seat stay like it was custom built for it, even while the Brompton is folded. It's very important to get the 75cm Bordo, as the larger Bordos will not fit.
- **Shopping cart mode** - With a rack and a front bag, the folded Brompton rolls like a shopping cart, which makes it much more welcome in stores.
- **Touch up paint** - The Brompton gets a lot of nicks and scratches.
