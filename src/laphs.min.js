!(function(e, t) {
  ...
  return (function(e) {
        ...
        if (u) {
          p && n(),
            "object" == typeof e &&
              ...
              ((t = e), (e = t.elements), delete t.elements),
            e || (e = "img[data-live-photo]"),
          ...
          return (
            Array.prototype.forEach.call(e, function(e) {
              if (
                ("string" == typeof e && (e = document.querySelector(e)), e)
              ) {
                var o = new l(e, t);
                i.push(o);
              }
    ...
    function(e, t, i) {
      ...
      function n(e, t) {
        if (e.paused) {
          ...
          (e.muted = !0),
            ...
            e.pause(),
            (e.muted = i),
            e.duration >= 0 ? n() : e.addEventListener("loadedmetadata", n);
        }
      }
      function r(e, t, i) {
        var n = document.createElement("div");
        (n.className = "live-photo"), n.setAttribute("data-live-photo", "");
        var r = document.createElement("img");
        (r.className = "live-photo-keyframe"), (r.src = e);
        var a = o(t, "live-photo-postroll", i, !0),
          s = o(t, "live-photo-video"),
          l = document.createElement("i");
        return (
          (l.className = "live-photo-icon"),
          n.appendChild(r),
          n.appendChild(a),
          n.appendChild(s),
          n.appendChild(l),
          { container: n, img: r, postroll: a, video: s, icon: l }
        );
      }
      function a() {
        var e = ["mousedown"];
      ...
      function l(e, t, i, o) {
        if (!(this instanceof l)) return new l(e, t, i, o);
        var n, a;
        if (
          (e instanceof HTMLElement &&
            ((o = t),
            (a = e),
            (t = a.getAttribute("data-live-photo")),
            (i = parseFloat(
              a.getAttribute("data-live-photo-still-image-time")
            )),
            (e = a.src)),
          o || (o = {}),
          (this.postrollMs = o.postrollMs || 375),
          (this.deactivateMs = o.deactivateMs || 500),
          (this.previewMs = o.previewMs || 500),
          (this.stillImageTime = i || NaN),
          !e && !o.noErrors)
        )
        ...
        (n = r(e, t, i)),
          a &&
            (a.parentNode.insertBefore(n.container, a),
            a.parentNode.removeChild(a)),
          (this.container = n.container),
          (this.img = n.img),
          (this.video = n.video),
          (this.postroll = n.postroll),
          (this.icon = n.icon),
          (this.__onVideoCanPlayThrough = this._onVideoCanPlayThrough.bind(
            this
          )),
          (this.__onVideoLoadededMetadata = this._onVideoLoadededMetadata.bind(
            this
          )),
          ...
          (this.__startPostrollPlayback = this._startPostrollPlayback.bind(
            this
          )),
          ...
          this.video.addEventListener(
            "canplaythrough",
            this.__onVideoCanPlayThrough
          ),
          this.video.duration
            ? (this._setDuration(this.video.duration), this._resetPostroll())
            : (this._setDuration(0),
              this.video.addEventListener(
                "loadedmetadata",
                this.__onVideoLoadededMetadata
              )),
          (this._playing = !1),
          (this._canPlayThrough = !1),
          (this._playWhenReady = !1),
          o.useEventHandlers !== !1 &&
            this._addEventHandlers(o.playEvents, o.stopEvents);
      }
      var d = i(2),
        u =
      ...
      (l.prototype = {
        _addEventHandlers: function(e, t) {
          ...
          (t && t !== !1) || (t = s),
            ...
            t.forEach(function(e) {
              e && i.addEventListener(e, p);
            });
        },
        _onVideoCanPlayThrough: function() {
          (this._canPlayThrough = !0),
            this._playWhenReady && ((this._playWhenReady = !1), this.play()),
        ...
        _onPostrollTimeUpdate: function(e) {
          this.postroll.currentTime >= this.stillImageTime - 0.1 &&
            this._resetPreview();
        },
        _clearTimeouts: function() {
          clearTimeout(this._resetVideoTimeout),
            ...
            this.postroll.removeEventListener(
              "timeupdate",
              this.__onPostrollTimeUpdate
            );
        },
        _setDuration: function(e) {
          (this.duration = e),
            ("number" != typeof this.stillImageTime ||
              isNaN(this.stillImageTime)) &&
              (this.stillImageTime = 0.5 * e),
            (this.previewStart = Math.max(
              0,
              this.stillImageTime - this.previewMs / 1e3
            ));
        },
          ...
          if (!this._playing) {
            if (!this._canPlayThrough)
              return (
                ...
                this._clearTimeouts(),
                this.load(),
                void this.container.classList.add("loading")
              );
            (this._playing = !0),
              this._clearTimeouts(),
              this._startPostrollPlayback(),
              (this.video.currentTime = 0),
              (this._resetPostrollTimeout = setTimeout(
                this.__startVideoPlayback,
                this.postrollMs
              )),
        ...
        stop: function() {
          this._playing &&
            ...
            (this._resetVideoTimeout = setTimeout(
              this.__resetPlayback,
              this.deactivateMs
            )));
        },
        preview: function() {
          this._playing ||
            ...
            (this._previewCompleteTimeout = setTimeout(
              this.__resetPreview,
              1e3 * (this.stillImageTime - this.previewStart)
            )),
    ...
    function(e, t, i) {
      ...
      function n(e) {
        function t(n) {
          (i = requestAnimationFrame(t)), e(n - (o || n)), (o = n);
        }
        var i, o;
        (this.start = function() {
          i || t(0);
          ...
          (this.stop = function() {
            cancelAnimationFrame(i), (i = null), (o = 0);
          });
      }
      function r(e, t, i, o) {
        function n(t) {
          Boolean(e[i]) === Boolean(o) && t.stopImmediatePropagation(),
            delete e[i];
        }
      ...
      function a(e, t, i, o) {
        ...
        o && r(e[t]), Object.defineProperty(e, t, { get: n, set: r });
      }
      function s(e, t, i) {
      ...
      function u(e, t, i) {
        (g || 0) + 200 < Date.now() && ((e[T] = !0), (g = Date.now())),
          i || (e.currentTime = t),
          (k[++L % 3] = (100 * t) | 0);
      }
      function c(e) {
      ...
      function p(e) {
        ...
        t.video.readyState >= t.video.HAVE_FUTURE_DATA
          ? (t.hasAudio ||
            ...
            u(t.video, t.driver.currentTime))
          : t.video.networkState !== t.video.NETWORK_IDLE ||
            t.video.buffered.length ||
            t.video.load(),
          t.video.ended && (delete t.video[T], t.video.pause(!0));
      }
      function h() {
        var e = this,
          t = e[w];
      ...
      function v(e) {
        ...
        i.driver.pause(),
          i.updater.stop(),
          t.webkitDisplayingFullscreen && t[P](),
          (i.paused && !e) ||
            ((i.paused = !0),
            i.hasAudio || l(t, "pause"),
            t.ended && ((t[T] = !0), l(t, "ended")));
      }
      function f(e, t) {
        var i = (e[w] = {});
        (i.paused = !0),
          ...
          e.addEventListener(
            ...
            function() {
              ...
              i.driver.src &&
                ...
                (u(e, 0, !0),
                (i.driver.src = e.src),
                t ? i.driver.play() : i.updater.stop());
            },
            !1
          ),
          e.addEventListener("webkitbeginfullscreen", function() {
            e.paused
              ? t && !i.driver.buffered.length && i.driver.load()
              : (e.pause(), e[E]());
          }),
          t &&
      ...
      function m(e) {
        ...
        (e[E] = e.play),
          ...
          (e.pause = v),
          a(e, "paused", t.driver),
          a(e, "muted", t.driver, !0),
          a(e, "playbackRate", t.driver, !0),
          a(e, "ended", t.driver),
          a(e, "loop", t.driver, !0),
          r(e, "seeking"),
          r(e, "seeked"),
    ...
    function(e, t, i) {
      ...
      "string" == typeof r && (r = [[e.id, r, ""]]),
        (t.use = t.ref = function() {
          return n++ || ((t.locals = r.locals), (o = i(7)(r, {}))), t;
        }),
      ...
      function o(e, t) {
        for (var i = 0; i < e.length; i++) {
          ...
          if (n) {
            ...
            for (; r < o.parts.length; r++) n.parts.push(d(o.parts[r], t));
          } else {
            for (var a = [], r = 0; r < o.parts.length; r++)
              a.push(d(o.parts[r], t));
