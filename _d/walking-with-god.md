...
- [Instructions for Adding Daily Entries](#instructions-for-adding-daily-entries)
...
When adding a new daily devotional reflection, follow this format:
...
5. **Related content** - Link to relevant blog posts using `{%include summarize-page.html src="/post-name" %}`
...
**Connection** - This person matters to me. When they talk about what they're learning, I want to actually understand, not just nod politely. This is Habit 5 in action: [Seek first to understand](/7-habits), then to be understood.
