...
(**Update EOY** _New technology in December got me inspired. Check out my process journal:_)
...
Get through calibrations without suffering (but pain is probably rightly required). And my [current approach](/manager-book#performance-reviews-calibrations-psc-olr-connections).
...
(**Update EOY** _Didn't really read much this year; next year I'm excited to see how we use AI tools for reading._)
