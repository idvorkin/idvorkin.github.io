...
(**Update EOY** _Very inspired thanks to new technology in December, check out my process journal:_)
...
Get through calibrations with out suffering (but pain is probably rightly required). And my [current approach](/manager-book#performance-reviews-calibrations-psc-olr-connections).
...
(**Update EOY** _Not doing many tricks, however doing a solid job of practicing, I have the sleights just need the mojo to perform them. Will try again in 2025!_)
...
(**Update EOY** _Didn't really read much this year, next year I'm excited to see how we use AI's for reading_)

**Outlive** (to start)

Peter Attia's book that goes into the science of living longer and better.
