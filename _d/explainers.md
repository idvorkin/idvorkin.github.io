...
- [Great Explainers in the Wild](#great-explainers-in-the-wild)
  - [Nicky Case — The Gold Standard](#nicky-case--the-gold-standard)
  - [Red Blob Games — Algorithms Made Visual](#red-blob-games--algorithms-made-visual)
...
The cost of building an explainer dropped from "major project" to "about the same effort as writing a blog post." That changes the calculus completely. You don't need to justify a month of work anymore — if something would be clearer as an interactive experience, just build it.
...
### Nicky Case — The Gold Standard

[Nicky Case](https://ncase.me/) makes the most beloved explainers on the internet. Each one takes a single concept and turns it into a playable experience with narrative, emotion, and discovery. The projects have thousands of GitHub stars because they actually change how you think:
...
- **[Loopy](https://ncase.me/loopy/)** (1.7k stars) — A tool for thinking in systems. Draw circles and arrows, then watch your system run
- **[To Build a Better Ballot](https://ncase.me/ballot/)** — Voting systems explained by actually voting in them
- **[We Become What We Behold](https://ncase.me/wbwwb/)** (1.4k stars) — A five-minute game about news cycles and attention

What makes Nicky's work exceptional: each piece has a **narrative arc** — it doesn't just present data, it walks you through a story with emotional stakes and reveals. You _feel_ the concept, not just see it.

### Red Blob Games — Algorithms Made Visual
