...
| [When AirPods Eat Your Words](https://idvorkin-ai-tools.github.io/airpods-mic-explainer/) | Hear how a Bluetooth mic destroys speech recognition — real audio, waveforms, dual-ASR forensics | Guessing why ASR "doesn't work" | [<i class="fa fa-github"></i>](https://github.com/idvorkin-ai-tools/airpods-mic-explainer) |
