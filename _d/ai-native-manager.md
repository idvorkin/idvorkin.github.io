...
AI is spawning a bunch of new terms — some useful, some hype. I keep the running glossary in its own post, [AI Native Vocabulary](/ai-native-vocab): Functional Collapse, Cognitive Debt, Heresies, Deep Blue, Infinite Loop, In Distribution, and more.

{% include summarize-page.html src="/ai-native-vocab" %}
