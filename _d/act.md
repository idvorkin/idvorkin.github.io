...
- **Fusion with self-concept** — "I am broken," "I am a loser," "I am always right"
- **Fusion with reasons** — all the reasons I can't, won't, or shouldn't change
...
- [/emotional-health](/emotional-health) — my running notes on emotional well-being. ACT is the most practical of the frameworks I've read and maps cleanly onto this.
- [/siy](/siy) — Search Inside Yourself. The closest cousin to ACT I've written about; SIY's "noticing emotions" and "emotions are not me" is essentially defusion and self-as-context under different names.
- [/awareness](/awareness) — Anthony de Mello on waking up. Goes deeper into the observing self than ACT does but covers the same ground.
- [/anxiety](/anxiety) — my anxiety notes. The Struggle Switch is exactly what my anxiety does when I resist it.
- [/shame](/shame) — shame notes. Chapter 28's fusion/avoidance/unworkable-action framework is the sharpest tool I've seen for working with shame specifically.
