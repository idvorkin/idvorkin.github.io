...
| [Magic Monitor](https://magic-monitor.surge.sh)                                     | Smart mirror app with instant replay, AI-powered smart zoom, and real-time playing card detection via YOLO. [<i class="fa fa-github"></i>](https://github.com/idvorkin/magic-monitor) [Side quest](/side-quests#magic-monitor-card-detection) |
